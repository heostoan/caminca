...
if (!isset($_SESSION['usuario_logeado'])) {
    ...
    $result = $objUsuario->Get_Reporte_Usuarios_Panaka();
    ?>
    <!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>Estado de participantes nivel PANACA</title>
            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Estado de participantes nivel PANACA</h1>
                            </div>
                            <!-- /.col-lg-12 -->
                        </div>
                        <!-- /.row -->
    ...
    <?php
    $result2 = $objUsuario->Get_Grap_Nivel_Edad(1);
    ?>
    ...
    ?>
            ...
            <script type="text/javascript">
    <?php
    $result2 = $objUsuario->Get_Grap_Nivel_Sexo(1);
    ?>
                google.charts.load('current', {'packages': ['corechart']});
                google.charts.setOnLoadCallback(drawChart);
    ...
    ?>
            ...
            <script type="text/javascript">
    <?php
    $result2 = $objUsuario->Get_Grap_Nivel_TipoColegio(1);
    ?>
                google.charts.load('current', {'packages': ['corechart']});
                google.charts.setOnLoadCallback(drawChart);
    ...
    ?>
            ...
            <script type="text/javascript">
    <?php
    $result2 = $objUsuario->Get_Grap_Nivel_NivlEstudios(1);
    ?>
                google.charts.load('current', {'packages': ['corechart']});
                google.charts.setOnLoadCallback(drawChart);
