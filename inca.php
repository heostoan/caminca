    ...
    <html>
        ...
        <body>
            ...
            <table cellspacing="0" cellpadding="0" class="tablero">
                    ...
                    <td class="mostasa paso">
                        <div class="area_ficha efecto" style="left: 0; right: 0; bottom: 0; top: 0">
                            <span class="ficha efecto">
                                <img src="img/fichaAzulAvanzado.png" class="img_ficha efecto" width="100%" />
                            </span>
                        </div>
                ...
                <tr>
                    ...
                    <td colspan="5" rowspan="5">
                        <div style="background-image: url(img/FondoNivel03.png); width: 100%; min-height: 670px; position: relative">
            ...
            <div class="cuadro_merito">
                <div style="text-align: center; width: 100%; font-weight: bold; padding-bottom: 5px; border-bottom: 1px solid black; margin-bottom: 3px">RANKING INCA</div>
                <table class="list_om">
                </table>
            </div>
